...
// 获取对应分类下的属性与属性值接口
export const reqAttr = (category3Id:number|string)=>request.get<any,AttrResponseData>(API.ATTR_URL+`${category3Id}`)
...
// 添加属性的接口方法
export const reqAddAttr = () =>
  request.post<any, any>(API.ADDATTR_URL)
